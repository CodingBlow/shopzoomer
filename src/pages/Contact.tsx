...
export const Contact = () => {
  return (
    <div className="container mx-auto px-4 py-16 mt-16">
      <h1 className="text-3xl font-bold mb-8 text-center">Get In Touch With Us</h1>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <a href="mailto:Hindustanrent@gmail.com" className="text-primary hover:underline">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <a href="tel:+917419011361" className="block hover:text-primary">
                  +91 74190 11361
                </a>
                <a href="tel:+917419011362" className="block hover:text-primary">
                  +91 74190 11362
                </a>
              </div>
            </div>
